...
const BookModules = (props) => (
  <Bundle load={cb => require.ensure([], require => cb(require('./components/book/Book')))}>
    {CustomComponent => CustomComponent ? <CustomComponent {...props} /> : null}
  </Bundle>
)
const BookList = (props) => (
  <Bundle load={cb => require.ensure([], require => cb(require('./components/book/List')))}>
    {CustomComponent => CustomComponent ? <CustomComponent {...props} /> : null}
  </Bundle>
)
const BookDetail = (props) => (
  <Bundle load={cb => require.ensure([], require => cb(require('./components/book/Detail')))}>
    {CustomComponent => CustomComponent ? <CustomComponent {...props} /> : null}
  </Bundle>
)
    ...
    <article className='Routes'>
      ...
      <div className='body'>
        <Switch>
          ...
          <Route path='/book' children={() => (
            <Switch>
              <Route exact path='/book' component={BookModules} />
              <Route path='/book/modules' component={BookModules} />
